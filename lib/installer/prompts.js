...
export async function runInstallPrompts(detectedEngines) {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: [
        { name: `Pipeline Core ${chalk.gray('(extract, planner, copywriter, builder, animator, size-animator, animated-metaphor, squared, vertical, validator)')}`, value: 'core', checked: true, disabled: 'sempre instalado' },
